...
<html>
  ...
  <body>
	...
	<div class="ui grid">
		...
		<div class="row">
            <table class="ui stackable single line striped selectable center aligned table" id="transactions-table">
...
?>
    ...
    <div id="pagination-trans" class="ui pagination menu"></div>
    <script>
    // Pagination for transactions table
    $(document).ready(function() {
      var rowsPerPage = 10;
      var rows = $('#transactions-table tbody tr');
      ...
      function showPage(page) {
        ...
        $('#pagination-trans').empty();
        for (var i = 1; i <= pageCount; i++) {
          var active = (i === page) ? 'active' : '';
          $('#pagination-trans').append('<a class="item '+active+'">'+i+'</a>');
        }
      }
      showPage(currentPage);
      $('#pagination-trans').on('click', 'a', function() {
