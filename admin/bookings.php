...
?>
		<div class="row">
            ...
            <table class="ui stackable single line striped selectable center aligned table" id="bookings-table">
...
?>
    ...
    $(document).ready(function() {
      var rowsPerPage = 10;
      var rows = $('#bookings-table tbody tr');
      ...
      function showPage(page) {
        ...
        for (var i = 1; i <= pageCount; i++) {
          ...
          $('#pagination').append('<a class="item '+active+'">'+i+'</a>');
        }
      }
