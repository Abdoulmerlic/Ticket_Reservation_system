...
<html>
  ...
  <body>
	...
	<div class="ui grid">
		...
		<div class="row">
            <table class="ui stackable single line striped selectable center aligned table" id="travelclass-table">
...
?>
    ...
    <div id="pagination-class" class="ui pagination menu"></div>
    <script>
    // Pagination for travelclass table
    $(document).ready(function() {
      var rowsPerPage = 10;
      var rows = $('#travelclass-table tbody tr');
      ...
      function showPage(page) {
        ...
        $('#pagination-class').empty();
        for (var i = 1; i <= pageCount; i++) {
          var active = (i === page) ? 'active' : '';
          $('#pagination-class').append('<a class="item '+active+'">'+i+'</a>');
        }
      }
      showPage(currentPage);
      $('#pagination-class').on('click', 'a', function() {
